...
export type MetricType = 'instagram_followers' | 'instagram_engagement' | 'tiktok_followers' | 'tiktok_views' | 'linkedin_followers' | 'web_traffic' | 'revenue' | 'valuation' | 'funding' | 'employee_count';
